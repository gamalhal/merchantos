  ...
  return (
    <main className="min-h-screen bg-slate-50 px-6 py-8">
      <div className="mx-auto max-w-7xl space-y-8">
        <header className="rounded-[2rem] bg-white p-8 shadow-[0_30px_60px_rgba(15,23,42,0.06)]">
          <h1 className="text-3xl font-semibold text-slate-950">المخزون</h1>
          <p className="mt-3 text-slate-600">
            هنا تتابع المنتجات الموجودة في المخزن وتعرض أحدث الأجهزة والإكسسوارات.
          </p>
        </header>
